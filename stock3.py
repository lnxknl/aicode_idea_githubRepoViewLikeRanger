...
# Set up logging
logging.basicConfig(filename='stock_viewer.log', level=logging.DEBUG)
...
class StockViewer:
    ...
    def fetch_stock_data(self, symbol):
        try:
            ...
            info = stock.info
            logging.debug(f"Fetched data for {symbol}: {info}")
            return {
                'symbol': symbol,
...
print("Stock viewer application with auto-refresh feature and error handling created successfully.")
print("Check the 'stock_viewer.log' file for debugging information.")
